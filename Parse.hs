...
action_8 (18) = happyShift action_28
action_8 (19) = happyShift action_29
...
action_20 (8) = happyGoto action_39
...
action_21 (8) = happyGoto action_38
...
action_40 (19) = happyShift action_29
...
action_42 (12) = happyShift action_12
...
action_42 (5) = happyGoto action_37
action_42 (6) = happyGoto action_9
action_42 (7) = happyGoto action_10
...
happyReduction_3 (HappyTerminal (TokenFloat happy_var_2))
	_
	 =  HappyAbsSyn4
		 (Fl (-1*happy_var_2)
	)
...
happyReduction_12 (HappyTerminal (TokenFloat happy_var_1))
	 =  HappyAbsSyn7
		 (EFl happy_var_1
	)
...
happyReduction_13 (HappyTerminal (TokenCelda happy_var_1))
	 =  HappyAbsSyn7
		 (Var happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenCorIzq -> cont 24;
	TokenCorDer -> cont 25;
	TokenSUMATORIA -> cont 26;
	TokenCONCATENACION -> cont 27;
	TokenABSOLUTO -> cont 28;
	_ -> happyError' (tk:tks)
	}
